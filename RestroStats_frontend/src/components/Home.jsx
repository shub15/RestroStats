...
export default function Home() {
    ...
    return (
        <div className={`min-h-screen p-6 md:p-8 lg:p-12 transition-colors duration-300 ${
            darkTheme ? 'bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white' : 
            ...
            {insightsData && (
                <div className={`mb-12 bg-gradient-to-r from-blue-500 to-purple-600 p-6 rounded-2xl shadow-xl transform hover:scale-102 transition-all duration-300 ${
                ...
                {analysisData && (
                    <>
                        ...
                        <div className={`rounded-2xl shadow-xl overflow-hidden ${
                            darkTheme ? 'bg-gradient-to-br from-gray-800 to-gray-900' : 'bg-gradient-to-br from-white to-gray-50'
            ...
            <div className={`rounded-2xl shadow-xl overflow-hidden ${
                ...
                {predictionData && (
                    <div className={`mt-6 p-6 rounded-xl transform transition-all duration-300 ${
                        darkTheme 
